...
import { _unwatch } from './fs-json-async';

const cwd = process.cwd();

beforeAll(async () => {
  fs.rmSync(`${cwd}/fs-json-async.tools1.deep7.json`, { recursive: true, force: true });
  fs.rmSync(`${cwd}/fs-json-async.tools2.deep7.json`, { recursive: true, force: true });
  fs.rmSync(`${cwd}/fs-json-async.tools3.deep7.json`, { recursive: true, force: true });
  fs.rmSync(`${cwd}/fs-json-async.personal1.deep7.json`, { recursive: true, force: true });
});
...
it('packager:fs-json-async', async () => {
  ...
  const { deep1, storage1_tools1, storage1_tools2, storage1_tools3 } = await (async () => {
    ...
    const storage1_tools1 = new deep1.Storage.FsJsonAsync({
      path: `${cwd}/fs-json-async.tools1.deep7.json`,
      package: tools1,
    });
    ...
    const storage1_tools2 = new deep1.Storage.FsJsonAsync({
      path: `${cwd}/fs-json-async.tools2.deep7.json`,
      package: tools2,
    });
    await storage1_tools2.mount(); // any initial errors will be throw here and unmount storage

    const storage1_tools3 = new deep1.Storage.FsJsonAsync({
      path: `${cwd}/fs-json-async.tools3.deep7.json`,
      package: tools3,
    });
  ...
  const { deep2, storage2_tools1, storage2_tools2, storage2_tools3, storage2_personal1, a2, b2, c2 } = await (async () => {
    ...
    const storage2_tools1 = new deep2.Storage.FsJsonAsync({
      path: `${cwd}/fs-json-async.tools1.deep7.json`,
    });
    ...
    const storage2_tools2 = new deep2.Storage.FsJsonAsync({
      path: `${cwd}/fs-json-async.tools2.deep7.json`,
      subscribe: false,
    });
    ...
    const storage2_tools3 = new deep2.Storage.FsJsonAsync({
      path: `${cwd}/fs-json-async.tools3.deep7.json`,
    });
    ...
    const storage2_personal1 = new deep2.Storage.FsJsonAsync({
      path: `${cwd}/fs-json-async.personal1.deep7.json`,
      data: deep2.query({
        _or: [
          { type: A2 },
          { type: B2 },
  ...
  const { deep3, storage3_personal1 } = await (async () => {
    ...
    const storage3_personal1 = new deep3.Storage.FsJsonAsync({
      path: `${cwd}/fs-json-async.personal1.deep7.json`,
    });
  ...
  await (async () => {
    ...
    const storage3_tools1 = new deep3.Storage.FsJsonAsync({
      path: `${cwd}/fs-json-async.tools1.deep7.json`,
    });
    await storage3_tools1.mount(); // and await mounting

    const storage3_tools2 = new deep3.Storage.FsJsonAsync({
      path: `${cwd}/fs-json-async.tools2.deep7.json`,
      subscribe: false,
    });
    await storage3_tools2.mount();

    const storage3_tools3 = new deep3.Storage.FsJsonAsync({
      path: `${cwd}/fs-json-async.tools3.deep7.json`,
    });
