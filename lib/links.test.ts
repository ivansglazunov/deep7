...
describe('links', () => {
  it('.type', () => {
    ...
    c.type = a;
    expect(c.type_id).toBe(a._id);
    expect(c.type._id).toBe(a._id);
    delete c.type;
    expect(c.type_id).toBe(undefined);
  ...
  it('.from', () => {
    ...
    const b = new a();
    const c = new b();
    expect(b.from_id).toBe(undefined);
    expect(b.from).toBe(undefined);
    expect(c.from_id).toBe(undefined);
    expect(c.from).toBe(undefined);
    b.from = a;
    expect(b.from_id).toBe(a._id);
    expect(b.from._id).toBe(a._id);
    c.from = b;
    expect(c.from_id).toBe(b._id);
  ...
  it('.to', () => {
    ...
    const b = new a();
    const c = new b();
    expect(b.to_id).toBe(undefined);
    expect(b.to).toBe(undefined);
    expect(c.to_id).toBe(undefined);
    expect(c.to).toBe(undefined);
    b.to = a;
    expect(b.to_id).toBe(a._id);
    expect(b.to._id).toBe(a._id);
    c.to = b;
    expect(c.to_id).toBe(b._id);
  ...
  it('.value', () => {
    ...
    const b = new a();
    const c = new b();
    expect(b.value_id).toBe(undefined);
    expect(b.value).toBe(undefined);
    expect(c.value_id).toBe(undefined);
    expect(c.value).toBe(undefined);
    b.value = a;
    expect(b.value_id).toBe(a._id);
    expect(b.value._id).toBe(a._id);
    c.value = b;
    expect(c.value_id).toBe(b._id);
